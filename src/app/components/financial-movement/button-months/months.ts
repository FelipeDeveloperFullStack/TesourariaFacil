import { IButtonMonths } from '../button-months/types'

export const months: IButtonMonths[] = [
  { monthName: 'Jan', monthNumber: 1, monthFullName: 'Janeiro' },
  { monthName: 'Fev', monthNumber: 2, monthFullName: 'Fevereiro' },
  { monthName: 'Mar', monthNumber: 3, monthFullName: 'Março' },
  { monthName: 'Abr', monthNumber: 4, monthFullName: 'Abril' },
  { monthName: 'Mai', monthNumber: 5, monthFullName: 'Maio' },
